...
Run:
  python -u dpok_imagereward.py --prompts_file prompts/prompts_paper.json \
      --total_samples 750 --sample_batch 10 --grad_steps 5 --is_batch 32 \
      --is_clip 1e-4 --guidance_scale 7.5 --pipe_dtype bf16 --save_dir ...
"""
